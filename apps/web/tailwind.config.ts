...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      fontSize: {
        "dashboard-title": ["2rem", { lineHeight: "1.15", letterSpacing: "-0.03em", fontWeight: "700" }],
        "dashboard-section": ["1.0625rem", { lineHeight: "1.35", letterSpacing: "-0.02em", fontWeight: "700" }],
        "dashboard-metric": ["1.875rem", { lineHeight: "1", letterSpacing: "-0.04em", fontWeight: "700" }],
        "dashboard-label": ["0.8125rem", { lineHeight: "1.4", fontWeight: "600" }],
        "dashboard-body": ["0.875rem", { lineHeight: "1.5", fontWeight: "500" }],
      },
      boxShadow: {
