    ...
    <div className="space-y-5 md:space-y-5">
      ...
      <section className="grid grid-cols-1 gap-5 xl:grid-cols-3">
        <div className="xl:col-span-2">
          <DashboardChart className="animation-delay-400" />
        </div>
      ...
      <section className="grid grid-cols-1 gap-5 lg:grid-cols-3">
        ...
        <OutreachPipeline className="animation-delay-520" />
        <UpcomingMeetings className="animation-delay-590" />
      </section>

      <RecentActivity className="animation-delay-680" />
    </div>
  );
}
